...
package com.skelril.OpenBoss.instruction;

import com.skelril.OpenBoss.InstructionResult;
import com.skelril.OpenBoss.condition.Condition;

@FunctionalInterface
public interface Instruction<I extends Instruction, C extends Condition> {
    public InstructionResult<I> process(C condition);
}
