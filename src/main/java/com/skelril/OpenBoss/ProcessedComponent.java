...
public abstract class ProcessedComponent {
    private final BindProcessor bindProcessor = new BindProcessor();
    private final DamageProcessor damageProcessor = new DamageProcessor();
    private final DamagedProcessor damagedProcessor = new DamagedProcessor();
    private final UnbindProcessor unbindProcessor = new UnbindProcessor();

    public BindProcessor getBindProcessor() {
    ...
    public DamagedProcessor getDamagedProcessor() {
        return damagedProcessor;
    }

    public UnbindProcessor getUnbindProcessor() {
